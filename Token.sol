...
contract Token is Context, IERC20, Ownable {
    ...
    constructor (address tokenOwner,string memory tokenName,
        ...
        uint8 setTaxFee, uint8 setLiqFee,  uint8 setMxTxPer, uint8 setMxWalletPer,
        uint8 _maxTaxFee, uint8 _maxLiqFee
        )  {
    ...
    function includeInReward(address account) external onlyOwner() {
        require(_isExcluded[account], "Account is not excluded from reward");
    ...
    function setMaxWalletPercent(uint256 maxWalletPercent) external onlyOwner() {
        require(maxWalletPercent >= minMxWalletPercentage && maxWalletPercent <=100,"maxTxPercent out of range");
    ...
    function recoverBEP20(address tokenAddress, uint256 tokenAmount) public onlyOwner {
        ...
        require(tokenAddress != address(this), "Cannot withdraw self tokens");
